      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-xs border border-slate-200 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500 bg-white"
          />
        </div>
        <button
          type="button"
                  ...
                  <tr key={m.id} className="hover:bg-slate-50/50 transition-colors">
                    <td className="p-3 pl-4">
                      <div className="flex items-center gap-2.5">
                        <div className="w-8 h-8 rounded-full bg-slate-100 border border-slate-200 text-slate-700 font-bold flex items-center justify-center text-[11px] uppercase shrink-0">
                          {initials}
                        </div>
                    ...
                    <td className="p-3">
                      {isOrgAdmin ? (
                        ...
                        <span className="inline-flex items-center gap-1 bg-slate-100 text-slate-700 border border-slate-200 px-2 py-0.5 rounded-full text-[11px] font-medium">
                    ...
                    <td className="p-3">
                      {m.assignedPlan ? (
                        <span className="inline-flex items-center gap-1 bg-blue-50 text-blue-700 border border-blue-200 px-2 py-0.5 rounded-md text-[11px] font-semibold">
                      ...
                      <div className="flex items-center justify-end gap-1.5">
                        {isOrgAdmin ? (
                          <button
                            ...
                            className="px-2.5 py-1 text-[11px] font-medium text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-md border border-slate-200 transition-colors cursor-pointer"
                          >
                            Demote
                          </button>
                        ) : (
                          <button
                            ...
                            className="px-2.5 py-1 text-[11px] font-medium text-purple-700 hover:bg-purple-50 rounded-md border border-purple-200 transition-colors cursor-pointer flex items-center gap-1"
                          >
                            <Crown className="h-3 w-3 text-purple-600" />
                            Make Admin
                          </button>
