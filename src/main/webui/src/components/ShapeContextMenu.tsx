...
export function ShapeContextMenu({
  ...
  return (
    <div
      ...
      className="absolute z-50 w-60 bg-white/95 backdrop-blur-md border border-slate-200 rounded-xl shadow-xl p-2 text-xs text-slate-800 flex flex-col gap-1.5 select-none animate-in fade-in zoom-in-95 duration-100"
